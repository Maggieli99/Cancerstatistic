...
```
**Issues with this dataset: **
1.There are only 19 countries in the dataset, and we may include more data inside the dataset. 
2.We only sample  from 1990 to 2019 to compare the country. 
3.The dataset are not large enough to shoow the main trend and death are affected by mutiple reasons so it is hard to analyze.
