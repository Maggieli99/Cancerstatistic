...
The dataset that contains the death rate and number among countries contain null variable Brazil. Besides, the health cost of GDP and health cost per capita contains many null data from 1995 to 2015. Here the missing plot can also show the fact that missing data are concentrated at health cost. The missing data of GDP and GNI are caused by Brazil in 2019.
